            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="subnav">
                <ul class="nav navbar-nav ">
                  <li class="active"><a href="index.php"><i class="fa fa-fw icon-ship-wheel"></i> Muro</a></li>
                  <li><a href="about.php"><i class="fa fa-fw icon-user-1"></i> Información</a></li>
