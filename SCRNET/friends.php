...
<head>
    ...
    if(isset($_GET['search'])){
     echo '<title>Buscar amigos</title>';
    }
if(isset($_GET['request'])){
     echo '<title>Solicitudes amigos</title>';
    }
else{
        echo '<title>Mis amigos</title>';
    }
                  ...
                  <span class="fa fa-ellipsis-h"></span>
                            ...
                            <div class="collapse navbar-collapse" id="subnav">
                                <ul class="nav navbar-nav ">
                                    <li><a href="index.php"><i class="fa fa-fw icon-ship-wheel"></i> Mi muro</a>
                                    </li>
                                    <li><a href="about.php"><i class="fa fa-fw icon-user-1"></i> Información</a>
                                    </li>
                                    <li class="active"><a href="user-public-users.html"><i class="fa fa-fw fa-users"></i> Amigos</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.navbar-collapse -->
