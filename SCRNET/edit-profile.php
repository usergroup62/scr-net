...
<body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="subnav">
                <ul class="nav navbar-nav ">
                  <li><a href="index.php"><i class="fa fa-fw icon-ship-wheel"></i> Mi Muro</a></li>
                  <li class="active"><a href="about.php"><i class="fa fa-fw icon-user-1"></i> Información</a></li>
                  <li><a href="friends.php"><i class="fa fa-fw fa-users"></i> Amigos</a></li>
                </ul>
  ...
  <script src="js/social/update.js"></script>
